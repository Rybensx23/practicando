...
const buscar = async () => {
    ...
    const url = `/practicando/API/permisos/buscar?permiso_usuario=${permiso_usuario}&permiso_rol=${permiso_rol}`;
    const config = {
        method : 'GET'
    }
...
const guardar = async (evento) => {
    ...
    const url = '/practicando/API/permisos/guardar';
...
const modificar = async () => {
    ...
    const body = new FormData(formulario)
    const url = '/practicando/API/permisos/modificar';
    const config = {
        method : 'POST',
        body
    }
...
const eliminar = async (e) => {
    ...
    if(await confirmacion('warning','¿Desea eliminar este registro?')){
        ...
        body.append('permiso_id', id)
        const url = '/practicando/API/permisos/eliminar';
        const headers = new Headers();
        headers.append("X-Requested-With","fetch");
        const config = {
            method : 'POST',
